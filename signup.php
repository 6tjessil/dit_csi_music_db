<?php
    ...
    $checkquery = "SELECT * FROM useraccount WHERE username = $username"; //Checks if username exsits
    $insertquery = "INSERT INTO useraccount(`username`, `password`) VALUES ('$username','$password')"; //Inserts new user data
